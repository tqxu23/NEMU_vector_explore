...
bool vp_enable();
def_THelper(vload) {
  def_INSTR_TAB_COUNT("??? 000 ? 00000 ????? ??? ????? ????? ??", vle);     // VLE
  def_INSTR_TAB_COUNT("??? 000 ? 10000 ????? ??? ????? ????? ??", vleff);   // VLEFF
  def_INSTR_TAB_COUNT("000 000 1 01000 ????? ??? ????? ????? ??", vlr);     // VL1R
  def_INSTR_TAB_COUNT("001 000 1 01000 ????? ??? ????? ????? ??", vlr);     // VL2R
  def_INSTR_TAB_COUNT("011 000 1 01000 ????? ??? ????? ????? ??", vlr);     // VL4R
  def_INSTR_TAB_COUNT("111 000 1 01000 ????? ??? ????? ????? ??", vlr);     // VL8R
  def_INSTR_TAB_COUNT("000 000 1 01011 ????? ??? ????? ????? ??", vlm);     // VLM
  def_INSTR_TAB_COUNT("??? 001 ? ????? ????? ??? ????? ????? ??", vlxe);    // VLUXEI
  def_INSTR_TAB_COUNT("??? 010 ? ????? ????? ??? ????? ????? ??", vlse);    // VLSE
  def_INSTR_TAB_COUNT("??? 011 ? ????? ????? ??? ????? ????? ??", vlxe);    // VLOXEI
  return EXEC_ID_inv;
}

def_THelper(vstore) {
  def_INSTR_TAB_COUNT("??? 000 ? 00000 ????? ??? ????? ????? ??", vse);     // VSE
  def_INSTR_TAB_COUNT("000 000 1 01000 ????? 000 ????? ????? ??", vsr);     // VS1R
  def_INSTR_TAB_COUNT("001 000 1 01000 ????? 000 ????? ????? ??", vsr);     // VS2R
  def_INSTR_TAB_COUNT("011 000 1 01000 ????? 000 ????? ????? ??", vsr);     // VS4R
  def_INSTR_TAB_COUNT("111 000 1 01000 ????? 000 ????? ????? ??", vsr);     // VS8R
  def_INSTR_TAB_COUNT("000 000 1 01011 ????? ??? ????? ????? ??", vsm);     // VSM
  def_INSTR_TAB_COUNT("??? 001 ? ????? ????? ??? ????? ????? ??", vsxe);    // VSUXEI
  def_INSTR_TAB_COUNT("??? 010 ? ????? ????? ??? ????? ????? ??", vsse);    // VSSE
  def_INSTR_TAB_COUNT("??? 011 ? ????? ????? ??? ????? ????? ??", vsxe);    // VSOXEI
  return EXEC_ID_inv;
}

def_THelper(vload_mmu) {
  def_INSTR_TAB_COUNT("??? 000 ? 00000 ????? ??? ????? ????? ??", vle_mmu);   // VLE
  def_INSTR_TAB_COUNT("??? 000 ? 10000 ????? ??? ????? ????? ??", vleff_mmu); // VLEFF
  def_INSTR_TAB_COUNT("??? 000 ? ?0000 ????? ??? ????? ????? ??", vle_mmu);   // VLE
  def_INSTR_TAB_COUNT("000 000 1 01000 ????? ??? ????? ????? ??", vlr_mmu);   // VL1R
  def_INSTR_TAB_COUNT("001 000 1 01000 ????? ??? ????? ????? ??", vlr_mmu);   // VL2R
  def_INSTR_TAB_COUNT("011 000 1 01000 ????? ??? ????? ????? ??", vlr_mmu);   // VL4R
  def_INSTR_TAB_COUNT("111 000 1 01000 ????? ??? ????? ????? ??", vlr_mmu);   // VL8R
  def_INSTR_TAB_COUNT("000 000 1 01011 ????? ??? ????? ????? ??", vlm_mmu);   // VLM
  def_INSTR_TAB_COUNT("??? 001 ? ????? ????? ??? ????? ????? ??", vlxe_mmu);  // VLUXEI
  def_INSTR_TAB_COUNT("??? 010 ? ????? ????? ??? ????? ????? ??", vlse_mmu);  // VLSE
  def_INSTR_TAB_COUNT("??? 011 ? ????? ????? ??? ????? ????? ??", vlxe_mmu);  // VLOXEI
  return EXEC_ID_inv;
}

def_THelper(vstore_mmu) {
  def_INSTR_TAB_COUNT("??? 000 ? 00000 ????? ??? ????? ????? ??", vse_mmu);   // VSE
  def_INSTR_TAB_COUNT("000 000 1 01000 ????? 000 ????? ????? ??", vsr_mmu);   // VS1R
  def_INSTR_TAB_COUNT("001 000 1 01000 ????? 000 ????? ????? ??", vsr_mmu);   // VS2R
  def_INSTR_TAB_COUNT("011 000 1 01000 ????? 000 ????? ????? ??", vsr_mmu);   // VS4R
  def_INSTR_TAB_COUNT("111 000 1 010 00 ????? 000 ????? ????? ??", vsr_mmu);   // VS8R
  def_INSTR_TAB_COUNT("000 000 1 01011 ????? ??? ????? ????? ??", vsm_mmu);   // VSM
  def_INSTR_TAB_COUNT("??? 001 ? ????? ????? ??? ????? ????? ??", vsxe_mmu);  // VSUXEI
  def_INSTR_TAB_COUNT("??? 010 ? ????? ????? ??? ????? ????? ??", vsse_mmu);  // VSSE
  def_INSTR_TAB_COUNT("??? 011 ? ????? ????? ??? ????? ????? ??", vsxe_mmu);  // VSOXEI
  return EXEC_ID_inv;
}
